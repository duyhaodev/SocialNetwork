...
public interface InteractionClient {
    ...
    InteractionResponse getInteraction(@PathVariable String postId, @RequestParam String userId);

    @GetMapping("/internal/interactions")
    List<InteractionResponse> getInteractions(@RequestParam List<String> postIds, @RequestParam String userId);
}
